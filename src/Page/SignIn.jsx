...
import { signInApi, toastr_position } from "../Api/Api";
...
const Signin = ({ translations }) => {
    ...
    return (
        <div className="min-h-screen bg-cover bg-center flex items-center justify-center relative"       style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?auto=format&fit=crop&w=1920&q=80')",

          }}
        >
          {/* Black overlay (adds shadow/dark tint over background) */}
          <div className="absolute z-[2] inset-0 bg-black/60"></div>

        <div className="px-8 w-[40%] m-auto z-[3] shadow-lg py-12 bg-secondary rounded-lg" >
            {token ? (
                ...
                <div>
                    {isLoginForm ? (
                        // LOGIN FORM
                        <div className="">
                            <LargeTitle className="pb-6 font-semibold text-primary text-center" text="Sign In"/>
